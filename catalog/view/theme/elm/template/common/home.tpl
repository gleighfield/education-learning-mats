...
$testimonials = array(
    ...
    '"At last my son has learnt his &#234;tre and avoir - without even noticing! By combining something very pleasurable (eating) with something more onerous (French prep), these mats take the ugh out of learning. Thank you and good luck!" <span>Samantha Fletcher (Parent)</span>',
    ...
    '"The children loved using the Times Tables mats. They worked in partners and were fully engaged in the activity. There was a healthy competitive atmosphere amongst the children to see who could finish first!" <span>E. Cahill, Early Years teacher, Beechcroft Primary School, Swindon</span>',
...
<div id="content">
    ...
    <div class="column-right">
        <div class="fpSlider">
		  ...
		  <li>
                    <img src="catalog/view/theme/elm/img/slider4.png">
                </li>
                <li>
                    <img src="catalog/view/theme/elm/img/slider5.png">
                </li>
            </ul>
    ...
    <div id="column-left">
        <div class="box customerComments">
            ...
            <div class="box-content">
                <p><?php echo $testimonial_comment; ?></p>
